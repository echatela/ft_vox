...
class Printer
{
	...
	const LabelMesh _createLabelMesh(const std::string& text, float size,
	                                 glm::vec2         pos,
...
public:
	void print(const std::string& text, glm::vec2 pos, float size,
	           const glm::ivec2& resolution,
	           const glm::vec3&  color = {0.0, 0.0, 0.0}) const;
